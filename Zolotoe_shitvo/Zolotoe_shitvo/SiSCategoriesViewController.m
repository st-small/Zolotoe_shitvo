...
@interface SiSCategoriesViewController () <FSPagerViewDataSource, FSPagerViewDelegate>
...
//    [self.itemsTable addGestureRecognizer:doubleTap];
    ...
    for (SiSProduct* obj in self.offerProducts) {
        ...
        [self.imagesArray addObject:obj.img];
    ...
    self.pagerView.itemSize = CGSizeMake(190, 190);
    self.pagerView.interitemSpacing = 16;
    self.pagerView.automaticSlidingInterval = 3.f;
...
- (FSPagerViewCell *)pagerView:(FSPagerView *)pagerView
            cellForItemAtIndex:(NSInteger)index {
    
    FSPagerViewCell *cell = [pagerView dequeueReusableCellWithReuseIdentifier:@"cell" atIndex:index];
    
    UIImage* img = self.imagesArray[index];
    cell.imageView.image = img;
    cell.imageView.contentMode = UIViewContentModeScaleAspectFill;
    cell.imageView.clipsToBounds = YES;
    //cell.textLabel.text = self.imagesIDs[index];
...
#pragma mark - UICollectonView Methods an Animations
